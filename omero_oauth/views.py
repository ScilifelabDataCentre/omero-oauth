...
from omero_version import build_year, omero_version
...
from .providers import OauthException, OauthProvider, providers
    ...
    def get_or_create_account_and_session(
        ...
        try:
            ...
            if e:
                ...
                uid = self.create_user(adminc, omename, email, firstname, lastname, gid)
